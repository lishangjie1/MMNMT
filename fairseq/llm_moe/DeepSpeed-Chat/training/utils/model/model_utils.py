...
def create_hf_model(model_class,
                    ...
                    ds_config=None,
                    rlhf_training=False,
                    disable_dropout=False, ds_inference=False):
    model_config = AutoConfig.from_pretrained(model_name_or_path)

    # print model configuration for debugging
    print_rank_0(model_config)
    ...
    if not rlhf_training:

        if tokenizer._pad_token is None:
            tokenizer._pad_token = tokenizer._unk_token  # for llama
