...
SAVE="/mnt/nas/users/lsj/moe/models/moe_model_stage_two_encoder_no_eom"
...
# stage two:
# fine-tuning all parameter and all languages
# lower lr to 1e-4
one_stage_model="/mnt/nas/users/lsj/moe/models/moe_model_stage_one_encoder_no_eom/checkpoint_last.pt"
...
python train.py $DATA \
  ...
  --lr 0.0001 --lr-scheduler inverse_sqrt --max-update $max_updates \
